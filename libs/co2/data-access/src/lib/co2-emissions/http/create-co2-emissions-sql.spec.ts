...
describe(createCo2EmissionsSql.name, () => {
  it('has a date range start filter', () => {
    const interval: Interval = Interval.fromISO('2022-01-22T00:00:00+02:00/2022-01-24T00:00:00+02:00');
  ...
  it('has a date range end filter', () => {
    const interval: Interval = Interval.fromISO('2022-01-23T00:00:00+02:00/2022-01-25T00:00:00+02:00');
    const sql = createCo2EmissionsSql(interval);
